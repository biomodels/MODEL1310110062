# MODEL1310110062: MODEL1310110062
...
`pip install git+https://github.com/biomodels/MODEL1310110062.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110062.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110062 as model`
...
The model of salivary gland glandular cells metabolism is derived from the
...
and identified by:
[MODEL1310110062](http://identifiers.org/biomodels.db/MODEL1310110062) .
